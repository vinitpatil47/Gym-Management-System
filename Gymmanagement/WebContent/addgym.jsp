	...
	<body>
		...
		<form method="post">
			...
			<br>
			  ...
			  <br>
			  <div class="row justify-content-md-center justify-content-sm-center justify-content-xs-center">
				    <label for="password" class="col-form-label-lg col-xs-5 col-sm-2 col-md-2 col-lg-2">Weekly Days</label>
				    <div class="col-xs-5 col-sm-7 col-md-7 col-lg-7">
				      <input type="password" name="password" class="form-control form-control-lg" id="password" placeholder="Weekly Days">
				    </div>
			  </div>
			  <br>
			  <div class="row justify-content-md-center justify-content-sm-center justify-content-xs-center">
				    <label for="password" class="col-form-label-lg col-xs-5 col-sm-2 col-md-2 col-lg-2">Timing</label>
				    <div class="col-xs-5 col-sm-7 col-md-7 col-lg-7">
